#include <vector>
#include "leetcode/linklist/141/solution.h"
...
TEST_F(SoltuionTest, hasCrle) {
    ...
    bool has_circle = _solution->hasCycle(dummy_one->next); 
    std::cout << "has_circle:" << has_circle << std::endl;
